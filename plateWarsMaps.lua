...
-- plateWarsMaps.name = "aldruhn"
plateWarsMaps.aldruhn.usedCells = {"-2, 7", "-2, 6"}
plateWarsMaps.aldruhn.teamSpawnLocations = {}
plateWarsMaps.aldruhn.teamSpawnLocations[1] = {
...
plateWarsMaps.aldruhn.teamSpawnLocations[2] = {
...
plateWarsMaps.balmora = {}
-- plateWarsMaps.name = "balmora"
plateWarsMaps.balmora.usedCells = {"-3, -2", "-2, -2"}
plateWarsMaps.balmora.teamSpawnLocations = {}
plateWarsMaps.balmora.teamSpawnLocations[1] = {
...
plateWarsMaps.balmora.teamSpawnLocations[2] = {
...
-- plateWarsMaps.caldera = {}
-- plateWarsMaps.name = "caldera"
-- plateWarsMaps.caldera.teamSpawnLocations = {}
-- plateWarsMaps.caldera.teamSpawnLocations[1] = {}
-- plateWarsMaps.caldera.teamSpawnLocations[2] = {}

plateWarsMaps.dagothur = {}
plateWarsMaps.dagothur.usedCells = {"Akulakhan's Chamber"}
plateWarsMaps.dagothur.teamSpawnLocations = {}
plateWarsMaps.dagothur.teamSpawnLocations[1] = {
...
plateWarsMaps.dagothur.teamSpawnLocations[2] = {
